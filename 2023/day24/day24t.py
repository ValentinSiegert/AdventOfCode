# from https://www.reddit.com/r/adventofcode/comments/18pnycy/comment/keq7g67/
# import numpy as np
...
class Hail:
    ...
    def intersectXY(self, other):
        ...
        # intY = round(intY)
        selfFuture = (intX - self.px < 0 and self.vx < 0) or (intX - self.px > 0 and self.vx > 0) or (intX - self.px == 0 == self.vx)
        otherFuture = (intX - other.px < 0 and other.vx < 0) or (intX - other.px > 0 and other.vx > 0) or (intX - other.px == 0 == other.vx)
            ...
            for negX in (-1, 1):
                for negY in (-1, 1):
                    ...
                    if aZ == nZ:
                        ...
                        print(f'H.getT(inter) = {H.getT(inter)}, H.vx = {H.vx}, H.px = {H.px}, inter[0] = {inter[0]}')
                        print(
